...
<html lang="en">
	<head>
		...
		<![endif]-->
		<?php include_once('assets/_inc/wp_bootstrap_analytics.php') ?>
		
		<!-- Thayer Pixel NEW -->
		<script type="text/javascript" src="//nexus.ensighten.com/choozle/3126/Bootstrap.js"></script>
    	    ...
    	    <div class="container">
    	        ...
    	        <div class="collapse navbar-collapse navbar-ex1-collapse">
    	            <ul class="nav navbar-nav">
			    	    ...
			    	    <li class="run-btn <?php if(is_page('run-barefoot-5k')): ?>active<?php endif; ?>"><a href="<?php bloginfo('url') ?>/run-barefoot-5k">run barefoot 5k</a></li>
    	            </ul>
    	        </div>
    	        <!-- /.navbar-collapse -->
    	    </div>
