    	    ...
    	    <div class="container-fluid">
    	        <div class="navbar-header page-scroll">
    	            ...
    	            <a class="navbar-left" href="<?php bloginfo('url') ?>">
	    	            <img src="<?php bloginfo('stylesheet_directory') ?>/assets/images/BFL-logo.png" alt="<?php bloginfo('name') ?>" class="img-responsive" />
	    	        </a>
    	        </div>
		
    	        <!-- Collect the nav links, forms, and other content for toggling -->
    	        <div class="collapse navbar-collapse navbar-ex1-collapse">
					<?php wp_nav_menu(array('menu'=>'main-menu', 'depth'=>3, 'container'=>false, 'menu_class'=>'nav navbar-nav','walker'=>new wp_bootstrap_new_navwalker())); ?>	    	        
    	        </div>
    	        <!-- /.navbar-collapse -->
    	    </div>
    	    <!-- /.container -->
