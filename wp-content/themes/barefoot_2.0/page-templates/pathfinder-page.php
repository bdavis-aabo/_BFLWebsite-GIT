				...
				<div class="row">
					<div class="pathfinder-form builder-form col-md-8 col-sm-7">
						...
						<?php elseif(is_page('become-a-pathfinder')): ?>
							<?php echo do_shortcode('[contact-form-7 id="16" title="Email Subscription"]') ?>
						<?php endif; ?>
					</div>
						...
						<?php if(is_page('realtor-pre-grand-opening-rsvp')): ?>
							<div class="pathfinder-event">
								...
								<div class="message-group">
									<a href="" title="Barefoot Lakes - Download Map" target="_blank" class="btn blue-btn">Download Map</a>
								</div>
							</div>
						<?php elseif(is_page('become-a-pathfinder')): ?>
