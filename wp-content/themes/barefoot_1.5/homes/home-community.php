...
?>
		...
		<section class="community-section">
			...
			<div class="community-heroimage">
				<a href="/the-homes" title="Barefoot Lakes - Homebuilders"><?php echo get_the_post_thumbnail($post->ID, 'full', array('class' => 'img-responsive alignhero')); ?></a>
				
				<?php /* if(is_front_page()): ?>
					<div class="grandopening-msg">
						<span>Richmond American Homes Model Now Open!</span>
